...
describe(Contact) do
  ...
  describe('#name') do
    it('returns the contact name') do
      test_contact = Contact.new({:name => "Joe Little", :job => "Mailman", :company => "US Postal Service", :id => "1"})
...
describe(Address) do
  ...
  describe('#street') do
    it('returns the address street') do
      test_address = Address.new({:street => "57 Barnes Rd.", :city => "Portland", :state => "Oregon", :zip => "97210", :number => "5031234567", :id => "1"})
...
describe(Phone) do
  ...
  describe('#home') do
    it('returns the home phone number') do
      test_phone = Phone.new({:home => "5038062572", :work => "5037899989", :id => "1"})
